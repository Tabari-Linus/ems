...
-- Resolve circular FK: employees.address_id → employee_addresses, employees.identification_id → employee_identifications
ALTER TABLE employees
    ADD COLUMN address_id        BIGINT REFERENCES employee_addresses (id),
    ADD COLUMN identification_id BIGINT REFERENCES employee_identifications (id);
